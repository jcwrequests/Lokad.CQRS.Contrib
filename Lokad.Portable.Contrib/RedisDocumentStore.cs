...
namespace Lokad.Portable.Contrib.AtomicStorage
{
    public sealed class RedisDocumentStore : IDocumentStore
    {
        ...
        public RedisDocumentStore(RedisClient redisClient)
        {
        ...
        {
            var container = new RedisDocumentReaderWriter<TKey, TEntity>(redisClient);
        ...
        {
            return new RedisDocumentReaderWriter<TKey, TEntity>(redisClient);
        }
